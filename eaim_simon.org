...
+++++++++
+++++++++
++ 1b  ++ Total number of organic compounds:  1
+++++++++
+++++++++
...
++BLOCK++
+++++++++
++ 3a  ++ -> Compound Name: TEA
++ 3b  ++ -> Molar Mass (g): 101.19D0 
++     ++    
++     ++    
++     ++    
++ 4   ++ -> Molar Volume (cm3 mol-1): 139.188D0
++     ++    
++     ++    
++     ++
...
++ 8a  ++ ->   for the reaction +H3NR(aq) = H+(aq) + H2NR(aq): 1.7783E-11
++ 8b  ++ -> Enthalpy change (kJ mol-1): 44.145
++ 8c  ++ -> Name of amine cation +H3NR(aq): TEA+
++     ++    
...
++ 10b ++ -> Parameters or groups for the equation: 3*CH3 2*CH2 1*CH2N 
...
++     ++                  ** OR **
++     ++    
++ 12d ++ -> Vapour pressure of the Pure Compound (p0, atm): 8.9149D-2
++ 12e ++ -> Enthalpy change for p0 (kJ mol-1): 34.96    
++ 12f ++ -> Heat capacity change (J mol-1 K-1): -96.30
...
++ 13a ++ -> solution saturated with respect to the solid: 0.341D0   
...
++     ++    ----------------------
++     ++    Activity (Ks, on a molality basis) in a    
++ 14a ++ -> solution saturated with respect to the solid: 0 
++ 14b ++ -> Enthalpy change for Ks (kJ mol-1):
++ 14c ++ -> Heat capacity change (J mol-1 K-1): 
...
++     ++    ---------------------
++     ++    Activity (Ks, on a molality basis) in a    
++ 15a ++ -> solution saturated with respect to the solid: 0. 
++ 15b ++ -> Enthalpy change for Ks (kJ mol-1):
++ 15c ++ -> Heat capacity change (J mol-1 K-1): 
...
++ 16b ++ -> Enthalpy change for Ks (kJ mol-1):
++ 16c ++ -> Heat capacity change (J mol-1 K-1): 
...
++BLOCK++
+++++++++
++ 3a  ++ -> Compound Name: decane
++ 3b  ++ -> Molar Mass (g): 100.D0 
++     ++    
++     ++    
++     ++    
++ 4   ++ -> Molar Volume (cm3 mol-1): 100.D0
++     ++    
++     ++    
++     ++
++ 5   ++ -> Organic case number (defines partitioning behaviour): 2
++     ++    
++     ++    
++     ++    
++     ++    1st Dissociation Constant (mol kg-1),
...
++     ++    ---------------------------------------------------------
++ 10a ++ -> Equation for this solute (1,2,3,4): 4
++ 10b ++ -> Parameters or groups for the equation: 
++     ++    *Choices: 1 - Raoult's law
++     ++              2 - McGlashan eqn. (enter parameters)
++     ++              3 - Pitzer Simonson Clegg eqn. (enter parameters)
++     ++              4 - UNIFAC (enter structural groups)
...
++     ++    -----
++     ++    Activity (Ks, on a molality basis) in a    
++ 13a ++ -> solution saturated with respect to the solid: 
++ 13b ++ -> No. of water molecules of hydration: 
++ 13c ++ -> Enthalpy change for Ks (kJ mol-1):  
++ 13d ++ -> Heat capacity change (J mol-1 K-1): 
++ 13e ++ -> Molar volume of the solid (cm3 mol-1): 
