...
rhoi = [1000 1200 1400 1300 1400];

% Surface tension (N/m)
sigmai = [0.072 0.03 0.03 0.03 0.03];
...
starttimes = [logspace(-3,2,5) linspace(115,432000,3500)];
...
while time_start_loop < 2000*starttimes(end-2)
    ...
    mpi = median(output1(:,1:5),1) ./ NumbConc;  %[kg particle-1]
    Xmass = mpi ./ sum(mpi);
